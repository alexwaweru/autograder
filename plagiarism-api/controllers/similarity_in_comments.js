...
var similarity_in_comments = {
        /**
                 * @function
                 * @name similarity_in_comments
                 * @description Function gets the similarity in comments between two files                 * @param {String} fileA: One of the two source code file's name
                 * @param {String} fileA: One of the two source code file's name
                 * @param {String} fileB: One of the two source code file's name
        */
    similarity: function(fileA, fileB, language){
...
// Tests
// console.log(similarity_in_code.similarity('similarity_in_code.js', 'similarity_in_length.js'));
